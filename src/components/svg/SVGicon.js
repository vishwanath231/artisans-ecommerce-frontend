...
const SVGicon = ({languageIcon, locationIcon, infoIcon, headerUserIcon, searchIcon, wishlistIcon, cartIcon, NavbarUserIcon, phoneIcon, facebookIcon, instagramIcon, twitterIcon, pinterestIcon, airtelIcon, americanExpressIcon, googlePayIcon, masterIcon, paytmIcon, payzappIcon, rupayIcon, visaIcon }) => {
    
    return (

        <>
            { languageIcon ? 
                <svg className='language__svg w-5 h-5 fill-black hover:fill-pink-600 mr-1' viewBox="0 0 512.000000 512.000000">
            ...
            { locationIcon ? 
                <svg className='location__svg w-5 h-5 fill-black hover:fill-pink-600 mr-1' viewBox="0 0 512.000000 512.000000">
            ...
            { infoIcon ? 
                <svg className='info__svg w-5 h-5 fill-black hover:fill-pink-600 mr-1' viewBox="0 0 512.000000 512.000000">
                <title>Contact</title>
                <g transform="translate(0.000000,512.000000) scale(0.100000,-0.100000)" stroke="none">
            ...
            { headerUserIcon ? 
                <svg className='user__svg w-5 h-5 fill-black hover:fill-pink-600 mr-1' viewBox="0 0 400.000000 400.000000">
                <title>User</title>
            ...
            { facebookIcon ?
                <svg viewBox="0 0 24 24"  className='w-5 h-5 fill-black hover:fill-pink-600' >
